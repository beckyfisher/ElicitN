...
#MODE
plot(rep(c(1),2), log(rep(c(ss.mode.results$lower, ss.mode.results$upper),1))
...
lines(c(1,2), log(rep(ss.mode.results$lower,2)),lwd=2)
lines(c(1,2), log(rep(ss.mode.results$upper,2)),lwd=2)
...
lines(c(1,2), log(rep(feedback.mode.results$new.lower,2)), col="red" ,lwd=2)
lines(c(1,2), log(rep(feedback.mode.results$new.upper,2)), col="red",lwd=2)
