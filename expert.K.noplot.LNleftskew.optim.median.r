...
#source("expert.K.noplot.LNleftskew.optim.R")
#Trish.K <- expert.K.noplot.LNleftskew(Lhat, Uhat, Mhat, pihat, .95)
...
#Lhat <- 100; Uhat<-200; pihat <-.9; Mhat <- 170; new.alpha=.95
...
expert.K.noplot.LNleftskew <-function(Lhat, Uhat, Mhat, pihat, new.alpha, best.type.status, ee.type){
...
feedback.mode.results <- feedbackLN(fit.best.mode.mu, fit.best.mode.sig, pihat,
                                    Lhat, Uhat,new.alpha=new.alpha)
